  ...
  return(
    <div className={`${cardClass} shadow-2xl`}>
      ...
      <div className="flex justify-between p-3 bg-[#292B32]">
        <div className="flex flex-col"><span className="text-[12px] font-normal">Total Events</span><span className="text-[14px] font-medium">48 Events</span></div>
        <div className="flex flex-col"><span className="text-[12px] font-normal">Sport</span><span className="text-[14px] font-medium">Baseball</span></div>
      </div>
      </div>
      </>
      )
...
<div className="flex flex-col text-center gap-3 mt-4">
        <div className="text-[17px]">Las Vegas Aviators
        </div>
        ...
        <div className="text-[14px] font-normal">Las Vegas Ballpark, Las Vegas, Nevada</div>
        </div>
        <div className="bg-black text-[13px] px-[30px] py-[10px] mt-3 mb-3 text-center">Take Flight Collection</div>
